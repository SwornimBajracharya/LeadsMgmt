    ...
    <div class="container-fluid">
      ...
      <div class="container-body">
        ...
        <div class="row col-md-12 col-sm-12 col-xs-12">
          <div class="panel panel-default page-info2">
            <div class="panel-body" style="border: none;">
              <h3>Students List Page</h3>
              <div class="row">
                <p class="pull-left">You can view your all available students from here.</p>
                <p class="pull-right">Leads / Students List <strong>All</strong></p>
              </div>
            </div>
          </div>
        ...
        <div class="row col-md-12 col-sm-12 col-xs-12 panel2">
          ...
          <div class="panel panel-heading">Students Listing Table</div>
                ...
                <tbody>
                  ...
                  @foreach ($leads as $lead)
                    <tr>
                      ...
                      <td>
                        N/A
                        {{-- <a href=""><i class="glyphicon glyphicon-ok" style="color: #58B72B; font-size: 15px;" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Convert to Lead" onclick="return confirm('Are you sure want to convert this studnet to lead?')"></i></a>&nbsp;&nbsp; --}}
                      </td>
                    </tr>
                  @endforeach
                </tbody>
